...
export class WelcomePage implements OnInit {
  ...
  response = {
    "data": [
        {
            "img": "http://localhost/daily_fruit_admin/upload/slider/1680931180438.png",
            "text": null
        },
        {
            "img": "http://localhost/daily_fruit_admin/upload/slider/1680932874152.png",
            "text": "aa"
        }
    ],
    "admin": {
        ...
        "welcome_text": "Enjoy homemade meals, delivered to your doorstep with just a tap - introducing our tiffin box delivery app.",
    ...
    "lang": {
        ...
        "text": {
            ...
            "cart": "Manage Cart",
            "go_back": "Go Back",
            "cart_desc": "Choose your delivery days to receive subscription services and the price will be calculated accordingly. You can also skip a delivery by marking a day off from My Account after this, and the credited amount will go to your wallet.",
            "remove": "Remove",
            "day_desc": "These price are showing per day. when you select following options it will be changed as per your selections.",
            "continue": "Continue",
            ...
            "checkout_desc": "Choose your subscription time, before subscribe to longer one you can try for short time also. Any time you can cancel it.",
            "starting_date_desc": "Choose your starting date, when you want to start your subscription.",
            ...
            "success_desc": "Your order has been placed successfully. You can access your order detail from your account.",
            "my_order": "My Orders",
            "account_delete": "Your account and account related data deleted successfully. We will happy to see you again.",
            ...
            "date_desc": "Here is your delivery calendar, you can select the dates and can mark them if you dont want delivery on that days. Amount will be auto creadit in your wallet.",
            "date": "Date",
            "status": "Status",
            "on_way": "On the way",
            "reorder": "Click here for reorder",
            "cancel_sub": "Oops! Sorry to hear that you want to cancel your subscription. No worries, you can always resubscribe whenever you like.",
            ...
            "contact_desc": "Send us your message or feedback. We will contact you soon.",
            "send": "Send",
            "contact_msg": "Thank You! We have received your message. We will contact you soon.",
            "notes_order": "Any notes or comment about order",
            "find_meal": "Lets find your meal",
            "eat_happy": "Eat what makes you happy",
            "night_mode": "Night Mode",
            "rate_desc": "Please give your valuable feedback, We will use this for improve our service.",
  ...
  async loadData()
  {
    ...
    this.server.welcome().subscribe((response:any) => {
      ...
      // localStorage.setItem('setting',JSON.stringify(this.response.admin));
      // localStorage.setItem("app_lang",JSON.stringify(this.response.lang));
